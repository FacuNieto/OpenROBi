...
//  entrada6 = analogRead(5);
  ...
  Serial.print(map(ValorfiltradoAx1, -4800, 4800, 1620, 1800)); // Acelerometro 1 eje x
  Serial.print(",");
  ValorfiltradoAy1 = (alpha * accelerometer_y) + ((1 - alpha) * ValorfiltradoAy1);
  Serial.print(ValorfiltradoAy1); // Acelerometro 1 eje y
  Serial.print(",");
  ValorfiltradoAz1 = (alpha * accelerometer_z) + ((1 - alpha) * ValorfiltradoAz1);
  Serial.print(ValorfiltradoAz1); // Acelerometro 1 eje z
  Serial.print(",");
 // ValorfiltradoGx1 = (alpha * gyro_x) + ((1 - alpha) * ValorfiltradoGx1);
  ...
  Serial.print(map(ValorfiltradoGz1, -30000, 30000, 3060, 3240)); // Giroscopio 1 eje z
...
//  
//  Serial.print(map(Valorfiltrado1, 0, 1023, 0, 180)); //Pote 1
//  Serial.print(",");
//  Serial.print(map(Valorfiltrado2, 0, 1023, 180, 360)); //Pote 2
//  Serial.print(",");
//  Serial.print(map(Valorfiltrado3, 0, 1023, 360, 540)); //Pote 3
//  Serial.print(",");
//  Serial.print(map(Valorfiltrado4, 0, 1023, 540, 720)); //Pote 4
//  Serial.print(",");
//  Serial.print(map(Valorfiltrado5, 0, 1023, 720, 900)); //Pote 5
//  Serial.print(",");
//  Serial.print(map(Valorfiltrado6, 0, 1023, 900, 1080)); //Pote 6
//  Serial.print(",");
  ...
  Serial.print(",");
  Serial.println(map(ValorfiltradoAz3, -4800, 4800, 2520, 2700)); // Acelerometro 2 eje z
//  Serial.print(",");
